        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
                <div class="service-web-2">
                    <div class="content-web">
                        <h3>Application Mobile ANDROID</h3>
                        <p>Une application Android est une application mobile spécifiquement développée pour les smartphones utilisant le système d'application (appelé aussi système d'exploitation) Android acheté et développé par Google.
                        </p>
             ...
             <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
                <div class="service-web-3">
                    <div class="content-web">
                        ...
                        <p>Une application IOS, comme son nom l'indique, est une application numérique spécifiquement conçue et réalisée pour les téléphones mobiles iPhone développés par Apple.
                        </p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 mb-3">
                <div class="service-web-1">
                    <div class="content-web">
                        <h3>Application Mobile MULTIPLATEFORME</h3>
                        <p>Application Mobile multiplateformes commes son nom l'indique est une application mobile destinée à la fois aux smartphones Android et IOS (I-Phone).
                        </p>
				...
				<div class="form-left">
					...
					<div class="form-row">
						<select name="service" required>
						    <option class="option" value="">Voulez-vous une ?</option>
						    <option class="option" value="">Application ANDROID</option>
                            <option class="option" value="">Application IOS</option>
                            <option class="option" value="">Application Multiplateforme(Android et IOS)</option>
